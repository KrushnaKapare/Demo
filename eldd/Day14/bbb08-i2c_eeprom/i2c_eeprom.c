...
static int __init desd_driver_init(void)
{
    ...
    {
        // desd_i2c_client_eeprom = i2c_new_device(desd_i2c_adapter, &eeprom_i2c_board_info);   // for kernel 4.19
        desd_i2c_client_eeprom = i2c_new_client_device(desd_i2c_adapter, &eeprom_i2c_board_info); // for kernel 5.10
